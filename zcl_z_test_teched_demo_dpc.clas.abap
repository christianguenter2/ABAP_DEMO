class ZCL_Z_TEST_TECHED_DEMO_DPC definition
  public
...
protected section.
  ...
  methods PERSONSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_TEST_TECHED_DEMO_MPC=>TS_PERSON
    raising
  ...
  methods PERSONSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_TEST_TECHED_DEMO_MPC=>TT_PERSON
...
CLASS ZCL_Z_TEST_TECHED_DEMO_DPC IMPLEMENTATION.
...
*&* This class has been generated on 26.11.2015 10:06:34 in client 010
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_TEST_TECHED_DEMO_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA personset_create_entity TYPE zcl_z_test_teched_demo_mpc=>ts_person.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA personset_get_entity TYPE zcl_z_test_teched_demo_mpc=>ts_person.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_TEST_TECHED_DEMO_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA personset_get_entityset TYPE zcl_z_test_teched_demo_mpc=>tt_person.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA personset_update_entity TYPE zcl_z_test_teched_demo_mpc=>ts_person.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="CDS" name="personSet" binding="Z_TEST_CDS_VIEW_TECHED" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="personSet" dataSource="personSet" maxEditMode="RO" >| &
               | <sadl:query name="EntitySetDefault" >| &
               | </sadl:query>| &
               | <sadl:attribute name="PERNR" binding="PERNR" isKey="TRUE" />| &
               | <sadl:attribute name="VORNA" binding="VORNA" isKey="FALSE" />| &
               | <sadl:attribute name="NACHN" binding="NACHN" isKey="FALSE" />| &
               | <sadl:attribute name="FUNCTION" binding="FUNCTION" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = '20151126090625'
               iv_uuid              = 'Z_TEST_TECHED_DEMO'
               io_query_control     = me
