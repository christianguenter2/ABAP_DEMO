REPORT ZNOTE_1873396.

* IMPORTANT! Only valid for Releases 600 up to 606 (SAP_APPL)
* Do not run this program in a newer release!

* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 3.54 on 19.09.2013

* The individual coding starts at 'FORM action.' ( line 3.532 )
...
*       i_note          = '    "<note which indicates that report is not needed anymore>
  ...
  APPEND 'T028Y_SEPA'                             TO gt_tabname.   "#EC NOTEXT

"- DOMA DOMD ---------------------------------------------------------------------------- Domains
"-- LIMU DOMD FSEPA_REASON_CODE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'FSEPA_REASON_CODE'
...
"-- LIMU DOMD SEPA_USE_REMOVE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'SEPA_USE_REMOVE'
      i_devclass   = 'FIN_SEPA_EN'
      i_datatype   = 'CHAR'
      i_langu      = 'E'
      i_ddtext     = 'SEPA: Mandate Usage Remove'
      i_leng       = '000001':
...
"-- LIMU DOMD SEPA_USE_REMOVE (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'SEPA_USE_REMOVE'
      i_devclass   = 'FIN_SEPA_EN'
      i_datatype   = 'CHAR'
      i_langu      = 'D'
      i_ddtext     = 'SEPA: Verwendungsdaten entfernen'
      i_leng       = '000001':
...
"-- LIMU DTED FSEPA_REASON_CODE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'FSEPA_REASON_CODE'
      i_devclass  = 'FIN_SEPA_EN'
      i_domname   = 'FSEPA_REASON_CODE'
      i_logflag   = ''
      i_headlen   = '15'
...
"-- LIMU DTED FSEPA_REASON_CODE (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'FSEPA_REASON_CODE'
      i_devclass  = 'FIN_SEPA_EN'
...
"-- LIMU DOCU DEFSEPA_REASON_CODE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'FSEPA_REASON_CODE'
      i_langu     = 'E'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS Describes the reason for changing mandate status.',                                        "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS The reason code explains why the status of a mandate has been changed.',                   "#EC NOTEXT
                    '   You can choose a reason code when you create or change a mandate.',                        "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS You have defined the following reason codes for changing to status',                       "#EC NOTEXT
                    '   Locked:',                                                                                  "#EC NOTEXT
                    'K1 Reason Code,,Description',                                                                 "#EC NOTEXT
                    'T1 ,,Choose a reason code',                                                                   "#EC NOTEXT
                    'T1 01,,Direct debit failed',                                                                  "#EC NOTEXT
                    'T1 02,,Customer called',                                                                      "#EC NOTEXT
                    'T1 03,,Customer letter attached',                                                             "#EC NOTEXT
                    'AS When you change the mandate status to Locked, the default reason code',                    "#EC NOTEXT
                    '   the system chooses for the change depends on the Customizing for reason',                  "#EC NOTEXT
                    '   codes:',                                                                                   "#EC NOTEXT
                    'B1 If the reason code for the previous status also exists for the current',                   "#EC NOTEXT
                    '   status, the system continues to use this reason code.',                                    "#EC NOTEXT
                    'B1 If the reason code for the previous status does not exist for the',                        "#EC NOTEXT
                    '   current status, the system chooses the empty reason code, which in this',                  "#EC NOTEXT
                    '   example prompts you to choose a reason code.',                                             "#EC NOTEXT
                    'U1 Customizing',                                                                              "#EC NOTEXT
                    'AS You define the reason codes for changing mandate status in transaction',                   "#EC NOTEXT
                    '   <DS:TRAS.SEPA_RC_CUST>SEPA_RC_CUST</>.',                                                   "#EC NOTEXT
                    space.


"-- LIMU DOCU DEFSEPA_REASON_CODE (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'FSEPA_REASON_CODE'
      i_langu     = 'D'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS Beschreibt den Grund für die Änderung des Mandatsstatus.',                                 "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS Der Ursachencode erklärt, warum der Status eines Mandats geändert wurde.',                 "#EC NOTEXT
                    '   Sie können einen Ursachencode auswählen, wenn Sie ein Mandat anlegen',                     "#EC NOTEXT
                    '   oder ändern.',                                                                             "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS Sie haben die folgenden Ursachencodes für das Wechseln in den Status',                     "#EC NOTEXT
                    '   Gesperrt definiert:',                                                                      "#EC NOTEXT
                    'K1 Ursachencode,,Beschreibung',                                                               "#EC NOTEXT
                    'T1 ,,Wählen Sie einen Ursachencode aus',                                                      "#EC NOTEXT
                    'T1 01,,Lastschriftverfahren fehlgeschlagen',                                                  "#EC NOTEXT
                    'T1 02,,Kundenanruf',                                                                          "#EC NOTEXT
                    'T1 03,,Kundenbrief im Anhang',                                                                "#EC NOTEXT
                    'AS Wenn Sie den Mandatsstatus in Gesperrt ändern, wählt das System für die',                  "#EC NOTEXT
                    '   Änderung den Ursachencode in Abhängigkeit vom Customizing für die',                        "#EC NOTEXT
                    '   Ursachencodes aus:',                                                                       "#EC NOTEXT
                    'B1 Wenn der Ursachencode für den vorherigen Status auch für den aktuellen',                   "#EC NOTEXT
                    '   Status vorhanden ist, verwendet das System diesen Ursachencode',                           "#EC NOTEXT
                    '   weiterhin.',                                                                               "#EC NOTEXT
                    'B1 Wenn der Ursachencode für den vorherigen Status für den aktuellen Status',                 "#EC NOTEXT
                    '   nicht vorhanden ist, verwendet das System den leeren Ursachencode, der',                   "#EC NOTEXT
                    '   Sie in diesem Beispiel dazu auffordert, einen Ursachencode auszuwählen.',                  "#EC NOTEXT
                    'U1 Customizing',                                                                              "#EC NOTEXT
                    'AS Die Ursachencodes für die Änderung des Mandatsstatus definieren Sie in',                   "#EC NOTEXT
                    '   Transaktion <DS:TRAS.SEPA_RC_CUST>SEPA_RC_CUST</>.',                                       "#EC NOTEXT
                    space.


"-- LIMU DTED SEPA_LOCK_DAYS (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'SEPA_LOCK_DAYS'
      i_devclass  = 'FIN_SEPA_EN'
      i_domname   = ''
      i_datatype  = 'NUMC'
      i_decimals  = '000000'
      ...
      i_langu     = 'E'
      i_ddtext    = 'SEPA: Mandate Locked Days'
      i_reptext   = 'Lock Days'
      i_scrtext_s = 'Lock Days'
      i_scrtext_m = 'Lock Days'
      i_scrtext_l = 'Mandate Lock in Days'.


"-- LIMU DTED SEPA_LOCK_DAYS (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'SEPA_LOCK_DAYS'
      i_devclass  = 'FIN_SEPA_EN'
      ...
      i_langu     = 'D'
      i_ddtext    = 'SEPA: Sperre des Mandats (in Tagen)'
      i_reptext   = 'Sperrtage'
      i_scrtext_s = 'Sperrtage'
      i_scrtext_m = 'Sperrtage'
      i_scrtext_l = 'Sperrtage d. Mandats'.


"-- LIMU DOCU DESEPA_LOCK_DAYS (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'SEPA_LOCK_DAYS'
      i_langu     = 'E'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS You can lock a mandate in the case of a return for a specified number of',                 "#EC NOTEXT
                    '   days.',                                                                                    "#EC NOTEXT
                    'AS This lock is reflected in the system by the valid-from date of the',                       "#EC NOTEXT
                    '   mandate being moved into the future by the number of days you enter. The',                 "#EC NOTEXT
                    '   result is that it is not possible to use the mandate for the next N',                      "#EC NOTEXT
                    '   days.',                                                                                    "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS <ZH>1st Example</>',                                                                       "#EC NOTEXT
                    '/  The mandate is valid indefinitely (no valid-from and valid-to date are',                   "#EC NOTEXT
                    '   entered). The duration of the lock is 14 days. Today''s date is 02/02.',                   "#EC NOTEXT
                    '/  Result: The mandate is valid from 02/16 to infinity.',                                     "#EC NOTEXT
                    'AS <ZH>2nd Example</>',                                                                       "#EC NOTEXT
                    '/  The mandate is valid from 01/01/2012 to 02/10/13. The duration of the',                    "#EC NOTEXT
                    '   lock is 14 days. Today''s date is 02/02.',                                                 "#EC NOTEXT
                    '/  Result: It is no longer possible to use the mandate.',                                     "#EC NOTEXT
                    'AS <ZH>3rd Example</>',                                                                       "#EC NOTEXT
                    '/  The mandate is valid from 01/01/2012 to 07/31/2013. The duration of the',                  "#EC NOTEXT
                    '   lock is 14 days. Today''s date is 02/02.',                                                 "#EC NOTEXT
                    '/  Result: The mandate is valid from 02/16/2013 to 07/31/2013.',                              "#EC NOTEXT
                    space.


"-- LIMU DOCU DESEPA_LOCK_DAYS (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'SEPA_LOCK_DAYS'
      i_langu     = 'D'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS Sie können ein Mandat im Falle eines Rückläufers für eine bestimmte',                      "#EC NOTEXT
                    '   Anzahl an Tagen sperren.',                                                                 "#EC NOTEXT
                    'AS Diese Sperre wird im System abgebildet, indem das Gültig-ab-Datum des',                    "#EC NOTEXT
                    '   Mandats um die von Ihnen eingegebene Anzahl von Tagen in die Zukunft',                     "#EC NOTEXT
                    '   verschoben wird. Das Mandat kann dadurch für die nächsten n Tage nicht',                   "#EC NOTEXT
                    '   verwendet werden.',                                                                        "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &EXAMPLE&',                                                                                "#EC NOTEXT
                    'AS <ZH>Erstes Beispiel</>',                                                                   "#EC NOTEXT
                    '/  Das Mandat ist unbegrenzt gültig (kein Gültig-ab- und Gültig-bis-Datum',                   "#EC NOTEXT
                    '   eingegeben). Die Dauer der Sperre beträgt 14 Tage. Das heutige Datum ist',                 "#EC NOTEXT
                    '   der 02. Februar.',                                                                         "#EC NOTEXT
                    '/  Ergebnis: Das Mandat ist ab dem 16. Februar unbegrenzt gültig.',                           "#EC NOTEXT
                    'AS <ZH>Zweites Beispiel</>',                                                                  "#EC NOTEXT
                    '/  Das Mandat ist gültig vom 01.01.2012 bis zum 10.02.2013. Die Dauer der',                   "#EC NOTEXT
                    '   Sperre beträgt 14 Tage. Das heutige Datum ist der 02. Februar.',                           "#EC NOTEXT
                    '/  Ergebnis: Das Mandat kann nicht länger verwendet werden.',                                 "#EC NOTEXT
                    'AS <ZH>Drittes Beispiel</>',                                                                  "#EC NOTEXT
                    '/  Das Mandat ist gültig vom 01.01.2012 bis zum 31.07.2013. Die Dauer der',                   "#EC NOTEXT
                    '   Sperre beträgt 14 Tage. Das heutige Datum ist der 02. Februar.',                           "#EC NOTEXT
                    '/  Ergebnis: Das Mandat ist gültig vom 16.02.2013 bis zum 31.07.2013.',                       "#EC NOTEXT
                    space.


"-- LIMU DTED SEPA_USE_REMOVE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'SEPA_USE_REMOVE'
      i_devclass  = 'FIN_SEPA_EN'
      i_domname   = 'SEPA_USE_REMOVE'
      i_logflag   = ''
      i_headlen   = '12'
      ...
      i_langu     = 'E'
      i_ddtext    = 'SEPA: Mandate Usage Remove'
      i_reptext   = 'Remove Usage'
      i_scrtext_s = 'Remove Use'
      i_scrtext_m = 'Remove Usage'
      i_scrtext_l = 'Remove Usage'.


"-- LIMU DTED SEPA_USE_REMOVE (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname  = 'SEPA_USE_REMOVE'
      i_devclass  = 'FIN_SEPA_EN'
      ...
      i_langu     = 'D'
      i_ddtext    = 'SEPA: Verwendung aus Mandat entfernen'
      i_reptext   = 'Verw. entf.'
      i_scrtext_s = 'Vrw. entf.'
      i_scrtext_m = 'Verw. entf.'
      i_scrtext_l = 'Verwendung entfernen'.


"-- LIMU DOCU DESEPA_USE_REMOVE (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'SEPA_USE_REMOVE'
      i_langu     = 'E'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS If a payment run pays a payment using a SEPA mandate, the system stores',                  "#EC NOTEXT
                    '   this usage information in the mandate. The uses that follow control',                      "#EC NOTEXT
                    '   whether the system sets the indicator for a first use or follow-on use.',                  "#EC NOTEXT
                    '   If there is a return for a payment, then the system can delete the use',                   "#EC NOTEXT
                    '   information in the mandate.',                                                              "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
...
"-- LIMU DOCU DESEPA_USE_REMOVE (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      i_rollname  = 'SEPA_USE_REMOVE'
      i_langu     = 'D'
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS Wenn ein Zahlungslauf eine Zahlung mittels eines SEPA-Mandats begleicht,',                 "#EC NOTEXT
                    '   speichert das System diese Verwendungsinformationen im Mandat. Die',                       "#EC NOTEXT
                    '   nachfolgenden Verwendungen steuern, ob das System ein Kennzeichen für',                    "#EC NOTEXT
                    '   die Erstverwendung oder für eine Folgeverwendung setzt. Wenn es für eine',                 "#EC NOTEXT
                    '   Zahlung einen Rückläufer gibt, kann das System die',                                       "#EC NOTEXT
                    '   Verwendungsinformationen im Mandat löschen.',                                              "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &DEPENDENCIES&',                                                                           "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
...
"- TABL TABD ----------------------------------------------------------------------------- Tables
"-- LIMU TABD T028Y_SEPA (language: EN , source: EBS )
  ...
  CALL METHOD lcl_wb=>create_table     "#EC *
    EXPORTING
      ...
      i_protokoll  = 'X'
      i_langu      = 'E'
      i_ddtext     = 'Returns Activities: Change Mandate Status'.

  CLEAR ls_dd08v.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'MANDT'.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'MANDT'.
  ls_dd08v-checktable      = 'T000'.
  ls_dd08v-frkart          = 'KEY'.
  ls_dd08v-card            = 'CN'.
  ls_dd08v-cardleft        = '1'.
  ...
  REFRESH lt_dd05m.
  CLEAR ls_dd05m.
  ls_dd05m-tabname         = 'T028Y_SEPA'.
  ls_dd05m-fieldname       = 'MANDT'.
  ls_dd05m-fortable        = 'T028Y_SEPA'.
  ls_dd05m-forkey          = 'MANDT'.
  ls_dd05m-checktable      = 'T000'.
  ...
  CLEAR ls_dd08v.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'RRINT'.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'RRINT'.
  ls_dd08v-checktable      = 'T028Y'.
  ls_dd08v-frkart          = 'KEY'.
  ls_dd08v-card            = 'CN'.
  ls_dd08v-cardleft        = '1'.
  ...
  CLEAR ls_dd05m.
  ls_dd05m-tabname         = 'T028Y_SEPA'.
  ls_dd05m-fieldname       = 'RRINT'.
  ls_dd05m-fortable        = 'T028Y_SEPA'.
  ls_dd05m-forkey          = 'MANDT'.
  ls_dd05m-checktable      = 'T028Y'.
  ls_dd05m-checkfield      = 'MANDT'.
  ls_dd05m-primpos         = '0001'.
  APPEND ls_dd05m TO lt_dd05m.
  ...
  ls_dd05m-fieldname       = 'RRINT'.
  ls_dd05m-fortable        = 'T028Y_SEPA'.
  ls_dd05m-forkey          = 'RRINT'.
  ls_dd05m-checktable      = 'T028Y'.
  ls_dd05m-checkfield      = 'RRINT'.
  ...
  CLEAR ls_dd08v.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'ZBUKR'.
  ls_dd08v-tabname         = 'T028Y_SEPA'.
  ls_dd08v-fieldname       = 'ZBUKR'.
  ls_dd08v-checktable      = 'T001'.
  ls_dd08v-frkart          = 'KEY'.
  ls_dd08v-card            = 'CN'.
  ls_dd08v-cardleft        = '1'.
  ...
  CLEAR ls_dd05m.
  ls_dd05m-tabname         = 'T028Y_SEPA'.
  ls_dd05m-fieldname       = 'ZBUKR'.
  ls_dd05m-fortable        = 'T028Y_SEPA'.
  ls_dd05m-forkey          = 'MANDT'.
  ls_dd05m-checktable      = 'T001'.
  ls_dd05m-checkfield      = 'MANDT'.
  ls_dd05m-primpos         = '0001'.
  APPEND ls_dd05m TO lt_dd05m.
  ...
  ls_dd05m-fieldname       = 'ZBUKR'.
  ls_dd05m-fortable        = 'T028Y_SEPA'.
  ls_dd05m-forkey          = 'ZBUKR'.
  ls_dd05m-checktable      = 'T001'.
  ls_dd05m-checkfield      = 'BUKRS'.
  ls_dd05m-primpos         = '0002'.
  APPEND ls_dd05m TO lt_dd05m.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'T028Y_SEPA'
      i_fieldname = 'NEW_STATUS'
      i_rollname  = 'SEPA_STATUS'
      i_context   = 'USE_REMOVE'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      ...
      i_rollname  = 'FSEPA_REASON_CODE'
      i_context   = 'NEW_STATUS'.

  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname   = 'T028Y_SEPA'
      i_fieldname = 'LOCK_DAYS'
      i_rollname  = 'SEPA_LOCK_DAYS'
      i_context   = 'REASON_CODE'.

"- VIEW VIED ------------------------------------------------------------------------------ Views
"-- LIMU VIED V_T028Y_SEPA (language: EN , source: EBS )
  ...
  CLEAR ls_dd26v.
  ls_dd26v-viewname        = 'V_T028Y_SEPA'.
  ls_dd26v-tabname         = 'T028Y_SEPA'.
  ls_dd26v-tabpos          = '0001'.
  ls_dd26v-fortabname      = 'T028Y_SEPA'.
  APPEND ls_dd26v TO lt_dd26v.

  CLEAR ls_dd26v.
  ls_dd26v-viewname        = 'V_T028Y_SEPA'.
  ls_dd26v-tabname         = 'T028Y'.
  ls_dd26v-tabpos          = '0002'.
  ls_dd26v-fortabname      = 'T028Y_SEPA'.
  ls_dd26v-forfield        = 'RRINT'.
  ls_dd26v-fordir          = 'E'.
  APPEND ls_dd26v TO lt_dd26v.

  CALL METHOD lcl_wb=>create_view     "#EC *
    EXPORTING
      i_viewname   = 'V_T028Y_SEPA'
      i_devclass   = 'FIN_SEPA_EN'
      i_langu      = 'E'
      i_ddtext     = 'Change Mandate Status'
      i_aggtype    = 'V'
      i_roottab    = 'T028Y_SEPA'
      i_viewclass  = 'C'
      i_viewgrant  = ''
      i_globalflag = 'X'
      it_dd26v     = lt_dd26v[]
...
"-- LIMU MESS FIN_SEPA_EN006 (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      ...
      i_langu     = 'E'
      i_selfdef   = '3'
      i_text      = 'No GUID of mandate in settlement data of payment program'.


"-- LIMU MESS FIN_SEPA_EN006 (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '006':
      i_langu     = 'D'
      i_selfdef   = '3'
      i_text      = 'Kein GUID des Mandats in Abrechnungsdaten des Zahlungsprogramms'.


"-- LIMU MESS FIN_SEPA_EN007 (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '007':
      i_langu     = 'E'
      i_selfdef   = '3'
      i_text      = 'Cleared document &1 is not found in SEPA usage'.


"-- LIMU MESS FIN_SEPA_EN007 (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '007':
      i_langu     = 'D'
      i_selfdef   = '3'
      i_text      = 'Ausgeglichener Beleg &1 nicht in SEPA-Verwendung gefunden'.


"-- LIMU MESS FIN_SEPA_EN008 (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '008':
      i_langu     = 'E'
      i_selfdef   = '3'
      i_text      = 'Cleared document &1 is not found in Accounting Document'.


"-- LIMU MESS FIN_SEPA_EN008 (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '008':
      i_langu     = 'D'
      i_selfdef   = '3'
      i_text      = 'Ausgeglichener Beleg &1 nicht im Buchhaltungsbeleg gefunden'.


"-- LIMU MESS FIN_SEPA_EN009 (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '009':
      i_langu     = 'E'
      i_selfdef   = '3'
      i_text      = 'Paying company code &1 doesn''t have the payment method required by SEPA'.


"-- LIMU MESS FIN_SEPA_EN009 (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      i_msgid     = 'FIN_SEPA_EN'
      i_msgno     = '009':
      i_langu     = 'D'
      i_selfdef   = '3'
      i_text      = 'Zahlender Bukrs &1 verfügt nicht über von SEPA vorgeschriebenen Zahlweg'.

"- FUGR -------------------------------------------------------------------------- Function Group
"-- R3TR FUGR SEPA_MNDID_CUST (language: EN , source: EBS )
...
"-- R3TR FUGR SEPA_RETURN_FROM_BANK (language: EN , source: EBS )
  CALL METHOD lcl_wb=>create_function_group   "#EC *
    EXPORTING
      i_devclass   = 'FIN_SEPA_EN'
      i_area       = 'SEPA_RETURN_FROM_BANK'
      i_langu      = 'E'
      i_appl       = 'S'
      i_text       = 'SEPA: Return From Bank'.


"-- R3TR TOBJ V_T028Y_SEPAV (language: EN , source: EBS )

"-- R3TR VCLS VC_FIEB_RETURNS (language: DE , source: EBS )
  CALL METHOD lcl_wb=>create_logical_object "#EC *
    EXPORTING
      i_object   = 'VCLS'
      i_obj_name = 'VC_FIEB_RETURNS'
      i_devclass = 'FTE'
      i_langu    = 'D'
    EXCEPTIONS
      OTHERS     = 1.
  ...
  ls_vcldirt-vclname = 'VC_FIEB_RETURNS'.                             "#EC NOTEXT
  ls_vcldirt-text    = 'Rückläuferverarbeitung im Kontoauszug'.       "#EC NOTEXT
  ...
  ls_vcldirt-vclname = 'VC_FIEB_RETURNS'.                             "#EC NOTEXT
  ls_vcldirt-text    = 'Returns Processing in the Bank Statement'.    "#EC NOTEXT
  APPEND ls_vcldirt TO lt_vcldirt.
  ...
  CLEAR ls_vclstruc.
  ls_vclstruc-vclname    = 'VC_FIEB_RETURNS'.                         "#EC NOTEXT
  ls_vclstruc-object     = 'V_T028X'.                                 "#EC NOTEXT
  ls_vclstruc-predobject = 'V_T028X'.                                 "#EC NOTEXT
  ls_vclstruc-objpos     = '01'.                                      "#EC NOTEXT
  ls_vclstruc-objlevel   = '01'.                                      "#EC NOTEXT
  ...
  CLEAR ls_vclstruc.
  ls_vclstruc-vclname    = 'VC_FIEB_RETURNS'.                         "#EC NOTEXT
  ls_vclstruc-object     = 'V_T028Y'.                                 "#EC NOTEXT
  ls_vclstruc-predobject = 'V_T028Y'.                                 "#EC NOTEXT
  ...
  CLEAR ls_vclstruc.
  ls_vclstruc-vclname    = 'VC_FIEB_RETURNS'.                         "#EC NOTEXT
  ls_vclstruc-object     = 'V_T028Y_SEPA'.                            "#EC NOTEXT
  ls_vclstruc-predobject = 'V_T028Y'.                                 "#EC NOTEXT
  ls_vclstruc-objpos     = '04'.                                      "#EC NOTEXT
  ls_vclstruc-dependency = 'S'.                                       "#EC NOTEXT
  APPEND ls_vclstruc TO lt_vclstruc.

  CLEAR ls_vclstruc.
  ls_vclstruc-vclname    = 'VC_FIEB_RETURNS'.                         "#EC NOTEXT
  ls_vclstruc-object     = 'V_T028Z'.                                 "#EC NOTEXT
  ls_vclstruc-predobject = 'V_T028Y'.                                 "#EC NOTEXT
  ls_vclstruc-objpos     = '03'.                                      "#EC NOTEXT
  ls_vclstruc-objlevel   = '02'.                                      "#EC NOTEXT
  ls_vclstruc-dependency = 'S'.                                       "#EC NOTEXT
  APPEND ls_vclstruc TO lt_vclstruc.
  ...
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028X'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Interne Rückläufergründe Externen zuweisen'. "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.

  CLEAR ls_vclstruct.
  ls_vclstruct-spras      = 'D'.                                      "#EC NOTEXT
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Y'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Rückläuferaktivitäten'.                  "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.

  CLEAR ls_vclstruct.
  ls_vclstruct-spras      = 'D'.                                      "#EC NOTEXT
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Y_SEPA'.                           "#EC NOTEXT
  ls_vclstruct-objecttext = 'Mandatstatus ändern'.                    "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.

  CLEAR ls_vclstruct.
  ls_vclstruct-spras      = 'D'.                                      "#EC NOTEXT
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Z'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Geöffnete Posten ändern'.                "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.
  ...
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028X'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Assign Internal Return Reasons to External'. "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.
  ...
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Y'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Return Activities'.                      "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.
  ...
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Y_SEPA'.                           "#EC NOTEXT
  ls_vclstruct-objecttext = 'Change Mandate Status'.                  "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.
  ...
  ls_vclstruct-vclname    = 'VC_FIEB_RETURNS'.                        "#EC NOTEXT
  ls_vclstruct-object     = 'V_T028Z'.                                "#EC NOTEXT
  ls_vclstruct-objecttext = 'Change Open Items'.                      "#EC NOTEXT
  APPEND ls_vclstruct TO lt_vclstruct.
  ...
  CLEAR ls_vclstrudep.
  ls_vclstrudep-vclname    = 'VC_FIEB_RETURNS'.                       "#EC NOTEXT
  ls_vclstrudep-object     = 'V_T028X'.                               "#EC NOTEXT
  ls_vclstrudep-predobject = 'V_T028X'.                               "#EC NOTEXT
  APPEND ls_vclstrudep TO lt_vclstrudep.

  CLEAR ls_vclstrudep.
  ls_vclstrudep-vclname    = 'VC_FIEB_RETURNS'.                       "#EC NOTEXT
  ls_vclstrudep-object     = 'V_T028Y'.                               "#EC NOTEXT
  ls_vclstrudep-predobject = 'V_T028Y'.                               "#EC NOTEXT
  APPEND ls_vclstrudep TO lt_vclstrudep.

  CLEAR ls_vclstrudep.
  ls_vclstrudep-vclname    = 'VC_FIEB_RETURNS'.                       "#EC NOTEXT
  ls_vclstrudep-object     = 'V_T028Y_SEPA'.                          "#EC NOTEXT
  ls_vclstrudep-objfield   = 'RRINT'.                                 "#EC NOTEXT
  ls_vclstrudep-predobject = 'V_T028Y'.                               "#EC NOTEXT
  ls_vclstrudep-predfield  = 'RRINT'.                                 "#EC NOTEXT
  APPEND ls_vclstrudep TO lt_vclstrudep.

  CLEAR ls_vclstrudep.
  ls_vclstrudep-vclname    = 'VC_FIEB_RETURNS'.                       "#EC NOTEXT
  ls_vclstrudep-object     = 'V_T028Z'.                               "#EC NOTEXT
  ls_vclstrudep-objfield   = 'RRINT'.                                 "#EC NOTEXT
  ls_vclstrudep-predobject = 'V_T028Y'.                               "#EC NOTEXT
  ls_vclstrudep-predfield  = 'RRINT'.                                 "#EC NOTEXT
  APPEND ls_vclstrudep TO lt_vclstrudep.
...
"------------------------------------------------------------------------------------------------
  " VCLS VC_FIEB_RETURNS

"-- R3TR TOBJ VC_FIEB_RETURNSC (language: DE , source: EBS )
