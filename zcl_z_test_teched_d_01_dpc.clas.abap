class ZCL_Z_TEST_TECHED_D_01_DPC definition
  public
...
protected section.
  ...
  methods PERSONSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z_TEST_TECHED_D_01_MPC=>TS_PERSON
    raising
  ...
  methods PERSONSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z_TEST_TECHED_D_01_MPC=>TT_PERSON
...
CLASS ZCL_Z_TEST_TECHED_D_01_DPC IMPLEMENTATION.
...
*&* This class has been generated on 27.11.2015 14:42:59 in client 010
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z_TEST_TECHED_D_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA personset_create_entity TYPE zcl_z_test_teched_d_01_mpc=>ts_person.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA personset_get_entity TYPE zcl_z_test_teched_d_01_mpc=>ts_person.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z_TEST_TECHED_D_01_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA personset_get_entityset TYPE zcl_z_test_teched_d_01_mpc=>tt_person.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA personset_update_entity TYPE zcl_z_test_teched_d_01_mpc=>ts_person.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="CDS" name="personSet" binding="Z_TEST_CDS_VIEW" />| &
               |<sadl:resultSet>| &
